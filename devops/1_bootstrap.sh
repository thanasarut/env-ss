...
couchbase-cli bucket-create -c couchbase:8091 -u Administrator -p 090CE11ce --bucket markets --bucket-type couchbase --bucket-ramsize 100 --enable-flush 1
...
sleep 15
cbq -f ./src/init-index.n1ql -engine http://couchbase:8091 -u Administrator -p 090CE11ce
